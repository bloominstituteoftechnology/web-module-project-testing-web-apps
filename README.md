...
* Possible cases for tests: if the website is being displayed, if every single component of the input fied is being
* registered, and if the submit button works
