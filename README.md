...
automated testing is for insuring that the application does what it should through all iterations and that it manually checking whether its functioning doesn't waste precious effort.
