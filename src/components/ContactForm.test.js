...
test('renders THREE error messages if user enters no values into any fields.', async () => {
    ...
    expect(inputErrors[1]).toHaveTextContent("email must be a valid email address.")
    expect(inputErrors[2]).toHaveTextContent("lastName is a required field.")
});
